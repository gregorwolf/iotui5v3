sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/csw/iotui5v3/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.csw.iotui5v3.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/csw/iotui5v3/localService/mockserver"], function (mockserver) {
